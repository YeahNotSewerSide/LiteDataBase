...
if __name__ == '__main__':
   ...
   db.create_db('Test',2,10000)
   db.init_column('Test',0,'testcolumn1','integer')
   db.init_column('Test',1,'testcolumn2','float')
   for i in range(10000):
       db.set_value('Test','testcolumn1',i,'integer',i)
       db.set_value('Test','testcolumn2',i,'float',float(i))

   row = db.get_row('Test',5,['integer','float'])
   
   rw = db.where('Test','testcolumn1',5678,'integer',['integer','float'])
